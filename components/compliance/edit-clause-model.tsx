...
interface EditClauseModalProps {
    clause: ControlForm
    onUpdated: (clause: ControlForm) => void
}

export default function EditClauseModal({ clause, onUpdated }: EditClauseModalProps) {
    const [open, setOpen] = useState(false)
    const [form, setForm] = useState<ControlForm>(clause)
                        ...
                        >
                            ...
                            <SelectContent>
                                {availableStandards.map((std) => (
                                    <SelectItem key={std._id} value={std.title || std.name || ""}>
                                        {std.title || std.name}
                                    </SelectItem>
                                ))}
                            </SelectContent>
