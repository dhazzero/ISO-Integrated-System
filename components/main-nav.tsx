...
export function MainNav() {
  ...
  const allRoutes = [
    ...
    },
    {
      href: "/issues",
      label: "Manajemen Isu",
      icon: <FileWarning className="h-5 w-5 mr-2" />,
      active: pathname.startsWith("/issues"),
      requiresPermission: null, // Always visible - all departments can access
    },
    {
      href: "/risk",
      label: "Risiko",
    ...
    {
      href: "/user-access-review",
      label: "Akses Pengguna",
      icon: <ShieldCheck className="h-5 w-5 mr-2" />,
      active: pathname.startsWith("/user-access-review"),
      requiresPermission: null, // Visible to all authenticated users
    },
    {
      href: "/settings",
      label: "Pengaturan",
