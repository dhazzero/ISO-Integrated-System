...
const roleRestrictedRoutes: Record<string, string[]> = {
    ...
    '/user-access-review': ['superuser', 'admin', 'administrator', 'manager', 'hse_manager', 'superadmin'],
    '/api/user-access-reviews': ['superuser', 'admin', 'administrator', 'manager', 'hse_manager', 'superadmin'],
...
export async function middleware(request: NextRequest) {
    ...
    try {
        ...
        if (isSuperAdmin && (pathname === '/home' || pathname.startsWith('/documents') || pathname.startsWith('/risk') || pathname.startsWith('/audit') || pathname.startsWith('/compliance') || pathname.startsWith('/training') || pathname.startsWith('/reports') || pathname.startsWith('/user-access-review'))) {
            return NextResponse.redirect(new URL('/admin', request.url));
        }
