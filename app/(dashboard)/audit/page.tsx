      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex space-x-2">
            <AddAuditModal onAddAudit={handleDataAdded} type="scheduled" />
          </div>
        </div>
        ...
        <Tabs defaultValue="all" className="w-full">
          ...
          <TabsContent value="scheduled">
            <Card>
              <CardHeader>
                <CardTitle className="font-bold">Audit Dijadwalkan</CardTitle>
              </CardHeader>
              <CardContent>
                {isLoading ? (
                  <p className="text-center p-4">Memuat...</p>
                    ...
                    <tbody>
                      {isLoading ? (
                        ...
                        findings.map((finding) => (
                          <tr
                            key={finding._id}
                            className={cn("border-b hover:bg-muted/50", getRowColor(finding.severity))}
                          >
                            <td className="p-4">
                            ...
                            <td className="p-4">
                              <div className="flex space-x-1">
                                <Link href={`/audit/findings/${finding._id}`}>
                                  <Button
                                    variant="ghost"
                                    size="icon"
                                    title="Lihat"
