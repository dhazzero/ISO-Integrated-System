...
const actionConfig: Record<string, { color: string; bgColor: string; icon: React.ReactNode }> = {
    ...
    PAGE_VIEW: { color: 'text-teal-700', bgColor: 'bg-teal-100', icon: <Navigation className="h-4 w-4" /> },
    NAVIGATION: { color: 'text-emerald-700', bgColor: 'bg-emerald-100', icon: <MousePointerClick className="h-4 w-4" /> },
}
...
const moduleIcons: Record<string, React.ReactNode> = {
    ...
    'Navigasi': <Navigation className="h-4 w-4" />,
}
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-5">
                ...
                <Card>
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm font-medium">Kunjungan Halaman Hari Ini</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-bold">
                            {logs.filter(l =>
