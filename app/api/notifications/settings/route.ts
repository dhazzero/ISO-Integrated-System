...
const defaultNotificationSettings = {
    templates: [
        ...
        {
            id: 'ojk_compliance',
            name: 'OJK Compliance Reminder',
            description: 'Pengingat batas waktu pelaporan OJK',
            status: 'Aktif',
            daysBeforeNotify: 7,
            picEmail: '',
            picName: '',
        ...
        {
            id: 'sop_update',
            name: 'SOP Update Reminder',
            description: 'Pengingat pembaruan SOP yang mendekati kadaluarsa',
            status: 'Aktif',
            daysBeforeNotify: 30,
            picEmail: '',
            picName: '',
        ...
        {
            id: 'risk_register_update',
            name: 'Risk Register Update Reminder',
            description: 'Pengingat untuk memperbarui Risk Register secara berkala',
            status: 'Aktif',
            daysBeforeNotify: 14,
            picEmail: '',
            picName: '',
